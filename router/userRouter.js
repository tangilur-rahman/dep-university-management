...
user.get("/administrator-list", authUser, getAllAdministrators);
...
user.put("/administrator-update", authUser, updateAdministrator);
...
user.get("/administrator/search/:search", authUser, searchAdministrator);
